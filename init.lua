...
vim.keymap.set('n', '<left>', 'h<cmd>echo "Use h to move left"<CR>')
vim.keymap.set('n', '<right>', 'l<cmd>echo "Use l to move right"<CR>')
vim.keymap.set('n', '<up>', 'k<cmd>echo "Use k to move up"<CR>')
vim.keymap.set('n', '<down>', 'j<cmd>echo "Use j to move down"<CR>')
